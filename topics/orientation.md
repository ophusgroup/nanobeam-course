...
Zone-axis nanobeam patterns are strongly dynamical: intensities oscillate with thickness and small mistilts, which degrades matching against kinematical templates. **Precession electron diffraction (PED)** [](doi:10.1107/S2052252514022283) — rocking the beam on a cone (typically ~0.3–1°) while descanning below the sample — integrates through the rocking curve and produces more kinematical-like, more complete patterns:
