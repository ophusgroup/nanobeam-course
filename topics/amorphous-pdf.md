...
:class: important
- ▶️ [Pair distribution function of amorphous Ta](https://drive.google.com/file/d/1-fHnUWhyzVWk207TTyJSy-cSfJaQIXL8/view?usp=drive_link) — I(k) → S(k) → G(r), validated against the ground-truth atomic coordinates of the simulated sample.
:::
